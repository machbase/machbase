...
동작은 [DDL 동시성과 잠금](/dbms/reference/sql/syntax/ddl-syntax/#ddl-concurrency)을
참고하십시오.
...
[INDEX 문법](/dbms/reference/sql/syntax/index-syntax/#create-index-if-not-exists)의
규칙에 따라 별도로 검증합니다.
