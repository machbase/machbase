...
5. 같은 시각의 서버·클라이언트·loader 로그를 비교합니다.
...
[설정 레퍼런스](/dbms/reference/configuration/configuration/)에서 현재 릴리스의
...
전체 목록과 컬럼 의미는
[system 카탈로그](/dbms/reference/system-catalog/virtual-table-full/)을 참고합니다.
