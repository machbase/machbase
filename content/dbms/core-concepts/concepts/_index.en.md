...
supported aggregates, see the [Function Reference](../../reference/sql/dictionary/functions-full/).
...
area. Check [DDL Syntax](../../reference/sql/syntax-dictionary-sql/ddl-syntax/) before applying
changes.
...
[Time Zone Configuration](../../reference/configuration/dictionary-configuration-timezone/).
