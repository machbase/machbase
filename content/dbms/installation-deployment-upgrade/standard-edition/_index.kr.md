...
| Windows | MSI 설치 패키지 | [MSI 설치](/dbms/installation-deployment-upgrade/standard-edition/windows/msi/) |
...
**다음 읽을 내용**
- [Linux 환경 준비](/dbms/installation-deployment-upgrade/standard-edition/linux/preparation-environment-linux/)
- [Windows 환경 준비](/dbms/installation-deployment-upgrade/standard-edition/windows/preparation-environment-windows/)
