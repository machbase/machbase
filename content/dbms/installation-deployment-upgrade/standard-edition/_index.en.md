...
The Windows package is a ZIP archive or an installer. The installer can create environment
settings and shortcuts; extracting a ZIP requires the initialization steps below.
