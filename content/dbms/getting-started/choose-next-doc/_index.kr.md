...
| 장비명, 코드, 매핑 정보 관리 | [LOOKUP 설계](/dbms/data-modeling-table-design/table-types-design-type/design-lookup/), RDB 지원 버전에서는 [RDB 설계](/dbms/data-modeling-table-design/table-types-design-type/design-rdb-dbms-nfx/)와 [LOOKUP과 RDB 비교](/dbms/data-modeling-table-design/table-types-selection-type/comparison-rdb-vs-lookup/) |
