...
Machbase DBMS는 산업 IoT 센서 데이터와 금융 틱 데이터처럼 시간 순서로 끊임없이 유입되는 데이터를 고속으로 저장하고 분석하기 위해 설계된 시계열 데이터베이스입니다. Machbase를 이해하는 핵심은 "초 단위 이하로 쏟아지는 데이터를 어떻게 받아들이고, 효율적으로 보관하며, 다시 분석에 활용하는가"에 있습니다.
