...
**1. 보안 모델** -- 사용자 계정, 권한 체계, 인증 방식의 연동 구조를 파악합니다. SYS 계정을 기반으로 하며, 각 사용자에게 최소 권한만 부여하는 방식을 권장합니다.

**2. 계정 관리** -- 데이터베이스에 접근하는 주체를 관리합니다. 사용자 계정을 생성·삭제하고 비밀번호 정책(NONE/LOW/HIGH)을 적용하며, 8.5부터는 공개키 기반 AUTH KEY 인증도 지원합니다.
