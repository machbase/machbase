...
운영 환경에 Machbase를 배포하기 전, 다음 항목을 점검하세요. 각 항목은 보안 수준을 높이는 조치이며, 환경에 따라 선택적으로 적용할 수 있습니다.
...
서비스 계정의 비밀번호 유출 위험을 제거하려면 AUTH KEY(공개키 기반 인증)를 도입합니다.
...
자세한 설정 방법은 [AUTH KEY 인증](../authentication-auth-key/)을 참고하세요.

## 정기 점검 항목

운영 중에도 다음 항목을 주기적으로 점검합니다.
