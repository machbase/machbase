...
RDB 테이블과 다른 테이블 타입 간의 JOIN 패턴과 성능 최적화 방법을 다룹니다.
...
RDB 테이블은 TAG, LOG, LOOKUP 등 다른 테이블 타입과 JOIN할 수 있습니다.

### RDB - LOOKUP JOIN

기준 정보(LOOKUP)와 이력 데이터(RDB)를 조인하는 패턴입니다.
...
센서 계측값(TAG)과 이벤트 이력(RDB)을 조인하는 패턴입니다.
