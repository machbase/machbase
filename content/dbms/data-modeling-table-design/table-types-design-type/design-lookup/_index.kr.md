...
- **[UPDATE·DELETE 조건 설계](/dbms/data-modeling-table-design/table-types-design-type/design-lookup/design-condition-lookup-update-delete/)**
- **[백업·복구 지원 범위](/dbms/data-modeling-table-design/table-types-design-type/design-lookup/recovery-support-scope-backup-lookup/)**
- **[제약 및 주의사항](/dbms/data-modeling-table-design/table-types-design-type/design-lookup/limitations-lookup/)**
