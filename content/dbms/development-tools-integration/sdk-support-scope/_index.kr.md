...
SDK별 기능 지원 여부와 제약을 비교합니다. 설치, 연결, 함수와 전체 코드는 같은 장의 SDK별
페이지를 정본으로 사용합니다.
...
API별 NULL 처리 방법은 이 장의 SDK별 페이지를 참고합니다.
...
|-----|------------|-----------|---------------|
| **Machbase SQLCLI** | C / C++ | TCP 5656 | [SQLCLI](../cli-odbc/) |
| **ODBC** | C / C++ | TCP 5656 | [ODBC](../cli-odbc/) |
| **JDBC** | Java | TCP 5656 | [JDBC](../jdbc/) |
| **Python** | Python 3.6+ | TCP 5656 | [Python](../python/) |
| **.NET** | C# / VB.NET | TCP 5656 | [.NET](../net-connector/) |
| **Go (native)** | Go 1.22+ | TCP 5656 | [Go](../go/) |
| **Go (database/sql)** | Go 1.22+ | TCP 5656 | [Go](../go/) |
| **Node.js** | JavaScript / TypeScript | TCP 5656 | [Node.js](../node-js-typescript/) |
