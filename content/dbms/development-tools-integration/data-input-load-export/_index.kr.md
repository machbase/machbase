...
`tagmetaimport`는 TAG 측정값 입력 도구가 아닙니다. 정확한 옵션은
[명령행 도구](/dbms/reference/command-line-tools/)를 확인하십시오.
...
구문과 지원 옵션은
[LOAD DATA INFILE](/dbms/reference/sql/syntax/load-data-infile-syntax/)을
참고합니다.
...
명시합니다. 전체 옵션은
[machloader](/dbms/reference/command-line-tools/machloader/)를 참고합니다.
...
[SAVE DATA INTO](/dbms/reference/sql/syntax/save-data-into-syntax/)를
참고합니다.
