...
테이블 타입별 ALTER TABLE 지원 범위가 다릅니다. [테이블 타입별 관리 가능 범위](/dbms/schema-data-lifecycle/table-types-type-manageable/)를 미리 확인하세요.
...
**다음으로 읽을 내용:**
- [데이터 보존 정책](/dbms/schema-data-lifecycle/policy-data-retention/)
