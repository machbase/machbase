...
Machbase의 스키마 객체(테이블, 인덱스, 뷰)를 생성·변경·삭제하는 방법을 설명합니다.

- **[테이블 생성과 삭제](/dbms/schema-data-lifecycle/schema-objects-definition/create-delete/)**
- **[테이블 변경](/dbms/schema-data-lifecycle/schema-objects-definition/alter/)**
...
- **[LOOKUP JSON 컬럼 제약](/dbms/schema-data-lifecycle/schema-objects-definition/definition-column-lookup-json/)**: LOOKUP 테이블의 JSON 컬럼 제한과 대안
