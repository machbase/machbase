...
| Section | Description |
|---------|-------------|
| [Configuration property dictionary](./dictionary-configuration/) | Standard Edition server properties |
| [Cluster configuration property dictionary](./dictionary-configuration-2/) | Cluster Edition properties |
| [RS Cache property dictionary](./dictionary-rs-cache/) | Result Set Cache properties |
