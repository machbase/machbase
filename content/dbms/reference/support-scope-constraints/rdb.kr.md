---
type: docs
title: '16.6.3 TRANSACTION 기능 지원표'
weight: 30
toc: true
---
...
`AUTO_INCREMENT` 사용법은 [AUTO_INCREMENT](/dbms/reference/sql/syntax/auto-increment-syntax/), upsert는
...
- [TRANSACTION DDL과 DML](../../sql/syntax/)
