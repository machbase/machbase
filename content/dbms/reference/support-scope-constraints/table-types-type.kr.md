...
[DECIMAL과 NUMERIC 고정소수점 타입](../../sql/types/decimal-numeric-fixed-point/)을
참고하십시오.
...
row의 DEFAULT 규칙은 [DDL 문법](../../sql/syntax/ddl-syntax/#add-column)과
[숫자 ARRAY 타입](../../sql/types/array/)을 참고하십시오.
...
JSON 컬럼은 TAG, LOG, LOOKUP, TRANSACTION 테이블에서 지원합니다. VOLATILE 테이블은 JSON 타입 컬럼 생성을 지원하지 않습니다. LOOKUP 테이블의 JSON 컬럼은 일반 컬럼으로 사용할 수 있지만 primary key로는 사용할 수 없습니다. 상세 내용은 [JSON 타입의 테이블 타입별 지원 범위](../../sql/types/table-types-type-support-scope-json/)를 참고하십시오.
