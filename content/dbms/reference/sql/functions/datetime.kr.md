...
`FROM_TIMESTAMP`는 UTC 기준 1970-01-01 00:00:00부터 경과한 나노초 정수를 `DATETIME`으로 변환합니다.
`TO_TIMESTAMP`는 반대로 `DATETIME`을 같은 기준 시점부터 경과한 나노초 정수로 변환합니다.
