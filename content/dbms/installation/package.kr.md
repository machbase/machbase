...
|VERSION|패키지의 버전을 나타냅니다.<br>자세히는 _MajorVersion.MinorVersion.FixVersion.AUX_로 숫자와 문자로 분류됩니다.<br>- Major Version: 제품 주요 버전 - 숫자<br>- Minor Version: 동일한 주요 버전에서 비교적 큰 기능이 추가된 버전. DB 파일 / 프로토콜 호환성이 보장되지 않습니다. -숫자<br>- Fix Version: 동일한 주요 버전에서 버그 / 작은 기능이 추가된 버전. DB 파일 / 프로토콜 호환성이 보장됩니다. - 숫자<br>- AUX: 패키지 분류를 나타냅니다 -숫자<br> -- official: 일반 패키지<br> -- community: 커뮤니티 에디션 패키지|
...
|OPTIONAL|추가 패키지 한정자가 사용될 때 표시됩니다.<br>lightweight: Coordinator에 추가할 경량 패키지를 나타냅니다.|
