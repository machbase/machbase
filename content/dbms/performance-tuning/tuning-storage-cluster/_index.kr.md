...
weight: 70
---
성능 병목은 CPU보다 I/O에서 발생하는 경우가 훨씬 많습니다. TAG 테이블에 초당 수십만 건씩 Append되는 환경에서는 디스크 쓰기 속도가 수집 처리량의 상한선이 되고, 대용량 범위 조회에서는 디스크 읽기 속도가 응답 시간을 결정합니다. 스토리지 설정과 Cluster Edition 구성에서 성능을 높이는 방법을 다룹니다.
