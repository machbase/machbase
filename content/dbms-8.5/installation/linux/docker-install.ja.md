---
title : 'Docker へのインストール'
type : docs
weight: 30
toc: true
---

Machbase は Docker イメージを提供しています。Docker がインストール済みであることを前提に、次の手順で Machbase を実行します。

[Docker](https://hub.docker.com/search/?offering=community&q=) の導入については、[Docker インストールページ](https://hub.docker.com/search/?offering=community&q=)を参照してください。Machbase のイメージは [Docker Hub](https://hub.docker.com/r/machbase/machbase) にあります。
