      ...
      <div class="contact_inner">
        ...
        <div class="contact-short-div-wrap">
          <div class="contact-short-div">
            ...
            <input class="short-input" type="text" name="emailAddress"  id="emailAddress" />
          </div>
          <div class="contact-short-div">
            <span class="input-span">Country/Region*</span>
            <select class="short-input" id="countrySelect"></select>
          </div>
        </div>
        <div>
          ...
          <div class="radio-input-wrap">
            <div class="radio-div">
              <input class="radio-input" type="radio" checked name="contactRadio" />
              <span>Sales</span>
            </div>
            <div class="radio-div">
        ...
        <div>
          ...
          <textarea class="contact_input" id="helpText" type="text"> </textarea>
        </div>
        <div>
            ...
            <div id="modalDiv" class="modal">
              <div class="modal-content">
                ...
                <p class="policy_text">
                  ...
                  information items to be collected by the Company are as
                  follows:
                </p>
                <p class="policy_text">
                ...
                <p class="policy_title">Appendix of Privacy Policy</p>
                <p class="policy_text">
                ...
                <p class="policy_text">
                  ...
                  ∘ when the user selects to allow his or her personal
  ...
  const fullNameInput = document.getElementById("fullName");
        ...
        submitButton.addEventListener("click", function (event) {
            ...
            if (countrySelect.value === "") {
                alert("Country/Region을 선택하세요.");
                event.preventDefault();
            }
            if (helpText.value.trim() === "") {
                alert("What can we help you with?를 입력하세요.");
                event.preventDefault();
            }
            if (!privacyCheckbox.checked) {
                alert("Privacy Policy에 동의해야 합니다.");
                event.preventDefault();
            }
        });
